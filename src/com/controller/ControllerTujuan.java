...
public class ControllerTujuan {
    ...
    public void insert(){
        ...
        !frame.getTxtHarga().getText().trim().isEmpty()){
            ...
            b.setJam(frame.getTxtJam().getText());
    ...
    frame public void update(){
        if(!frame.getTxtID().getText().trim().isEmpty()){
            ...
            b.setHarga(frame.getTxtHarga().getText());
            b.setJam(frame.getTxtJam().getText());
            b.setId(int.parseInt(frame.getTxtID().getText())
            );implTujuan.update(b);
    ...
    public void delete(){
        if(!frame.getTxtID().getText().trim().isEmpty()){
            ...
            int id = int.parseInt(frame.getTxtID().getText());
    ...
    public void isiTableCariId(){
        ...
        lb = implTujuan.getCariId(frame.getTxtCariId().getText());
        
        tableModelTujuan tmb = new tableModelTujuan(lb);
        
        frame.getTabelData()set.Model(tmb);
        
        }
    
    public void cariid(){
        
        if(!frame.getTxtCariId().getText().trim().isEmpty()){
            implTujuan.getCariId(frame.getTxtCariId().getText());
            isiTableCariId();
        }else{
