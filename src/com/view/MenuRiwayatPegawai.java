 ...
 * @author FAISAL
 */
public class MenuRiwayatPegawai extends javax.swing.JFrame {
    
    ControllerTravel cbt;
    /**
     * Creates new form MenuRiwayatPegawai
     */
    public MenuRiwayatPegawai() {
        initComponents();
        cbt = new ControllerTravel(null,this);
        cbt.isiTable();
    }
    ...
    private void initComponents() {
        ...
        TabelData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "nama", "tujuan", "Tanggal Berangkat", "Status Pembayaran", "Harga", "No Kursi", "Jam", "No Polisi Mobil"
            }
        ));
    ...
    private void TabelDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelDataMouseClicked
        ...
        String ket = TabelData.getValueAt(baris,4).toString();
//        TxtLunas.setText(ket);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuRiwayatPegawai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
